...
function about() {
  return (
    <section className="about-section" id="aboutme">
        ...
        coding in C# and Unity by making my own games and really been loving every moment of it. The dream is to make a really awesome game 
        in the future that people can enjoy!</p>
        <div className="picture-div">
            <div className="picture-div-overlay"></div>
        </div>
    </section>
  );
}
